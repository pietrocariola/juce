...
private:
    ...
    juce::AudioParameterFloat* frequencyParam;  // LFO Frequency
    juce::AudioParameterFloat* sweepWidthParam; // width of LFO in samples
    juce::AudioParameterChoice* interpolationTypeParam; // interpolation type
